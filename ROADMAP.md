...
- **Completions:** receiver inference now follows prior direct local aliases in addition to obvious declarations and constructors; next add further safe AST-backed cases and curated AVEVA/E3D command presets.
