...
- **Completions:** receiver inference follows the latest prior direct local and typed form-member aliases in addition to obvious declarations and constructors; next add further safe AST-backed cases and curated AVEVA/E3D command presets.
