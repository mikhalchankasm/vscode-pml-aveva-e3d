...
- ✅ **Agent Kit Execution Safety** - Agent Kit commands require trusted workspaces, preserve quoted Windows file paths containing shell characters, use Windows-safe npm execution, and only auto-discover a sibling `e3d-pml-agent-kit` folder unless configured explicitly.
