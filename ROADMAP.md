...
- **Diagnostics:** keep default `.pmlfrm` noise low with explicit coverage for dynamic form-member paths and external form callbacks; next add further false-negative fixtures and make opt-in diagnostics explain why a warning is actionable.
