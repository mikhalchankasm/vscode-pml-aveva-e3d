...
- **Diagnostics:** keep default `.pmlfrm` noise low with explicit coverage for dynamic form-member paths, external form callbacks, and indexed unknown members; next make opt-in diagnostics explain why a warning is actionable.
