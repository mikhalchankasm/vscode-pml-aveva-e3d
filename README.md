...
[![Version](https://img.shields.io/badge/version-0.5.8-blue.svg)](https://github.com/mikhalchankasm/vscode-pml-aveva-e3d/releases)
...
1. Download `pml-aveva-e3d-0.5.8.vsix` from [Releases](https://github.com/mikhalchankasm/vscode-pml-aveva-e3d/releases)
...
1. Скачайте `pml-aveva-e3d-0.5.8.vsix` из [Releases](https://github.com/mikhalchankasm/vscode-pml-aveva-e3d/releases)
