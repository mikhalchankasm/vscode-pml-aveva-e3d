...
export const PDMS_COMMANDS: readonly PdmsCommandDefinition[] = [
	...
	{ name: 'at', category: 'navigation', brief: 'Positions the current element or command target at a location.' },
	{ name: 'autocolour', category: 'drawing', brief: 'Applies or removes automatic colour representation settings.' },
	{ name: 'auto', category: 'drawing', brief: 'Runs automatic view or drawing commands from command-style syntax.' },
	{ name: 'button', category: 'drawing', brief: 'Declares a toolbar or UI button from command-style syntax.' },
	{ name: 'call', category: 'system', brief: 'Calls a PML function or command from command-style syntax.' },
	{ name: 'calldrg', category: 'drawing', brief: 'Runs a drawing form or drawing command action.' },
	...
	{ name: 'finish', category: 'system', brief: 'Finishes the current module/session from command-style syntax.' },
	{ name: 'frame', category: 'drawing', brief: 'Declares or manipulates UI/tool frame command entries.' },
	{ name: 'function', category: 'system', brief: 'Sets a command/task function value from command-style syntax.' },
	{ name: 'gap', category: 'drawing', brief: 'Runs drawing gap placement or editing command syntax.' },
	{ name: 'getwork', category: 'system', brief: 'Gets the current writable work context.' },
	{ name: 'golabel', category: 'system', brief: 'Transfers execution to a PML1 command label.' },
	{ name: 'goto', category: 'navigation', brief: 'Navigates to a database element or module context.' },
	{ name: 'id', category: 'query', brief: 'Identifies picked elements or command-stream selection targets.' },
	...
	{ name: 'label', category: 'system', brief: 'Defines a PML1 command label target.' },
	{ name: 'limits', category: 'drawing', brief: 'Sets drawing or view limits from command-style syntax.' },
	...
	{ name: 'option', category: 'drawing', brief: 'Declares a toolbar or UI option from command-style syntax.' },
	{ name: 'onerror', category: 'system', brief: 'Configures PML1 error handling or label transfer.' },
	{ name: 'pin', category: 'model', brief: 'Sets pin direction, position, or copy data from command-style syntax.' },
	{ name: 'pml', category: 'system', brief: 'Runs PML command actions such as loading forms or macros.' },
	{ name: 'pmlfunction', category: 'system', brief: 'Sets a PML task function value from command-style syntax.' },
	{ name: 'position', category: 'navigation', brief: 'Sets a position using command-style syntax.' },
	...
	{ name: 'update', category: 'drawing', brief: 'Updates drawing, annotation, or model output from command-style syntax.' },
	...
	{ name: 'use', category: 'drawing', brief: 'Applies a drawing or representation style to selected elements.' },
	...
	{ name: 'paragon', category: 'system', brief: 'Enters the Paragon module from a command line.' },
	...
	{ name: 'speconmode', category: 'system', brief: 'Enters Specon command mode from Paragon command context.' },
	{ name: 'sppurp', category: 'system', brief: 'Sets task or special purpose metadata from command-style syntax.' },
